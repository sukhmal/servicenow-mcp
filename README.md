...
|-------------------|--------|------:|---------|
| IT Service Management (ITSM) | `it-service-management` | 61 | [README](src/tools/it-service-management/README.md) |
...
_54 tool modules · 357 tools across 15 ServiceNow module folders._
